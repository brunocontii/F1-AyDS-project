...
questions = [
    ...
    {name_question: 'What does the yellow flag with Safety Car indicate?', level: 'difficult', theme: 'career' },
    {name_question: 'What does the yellow flag with Virtual Safety Car indicate?', level: 'impossible', theme: 'career' },
    ...
    {name_question: 'What does the black flag with an orange circle and the driver\'s number indicate?', level: 'impossible', theme: 'career' },
    ...
    {name_question: 'What is the qualifying system used in Formula 1 to determine the starting order for the race?', level: 'difficult', theme: 'career' },
    ...
    {name_question: 'What is the maximum number of drivers allowed on a Formula 1 starting grid?', level: 'normal', theme: 'career' },
...
options = [
    ...
    ######                 FREES                     ######
    {name_option: 'Lewis Hamilton' , question_id: 94, correct: true},
    {name_option: 'Esteban Ocon' , question_id: 94, correct: false},
    {name_option: 'Franco Colapinto' , question_id: 94, correct: false},
    {name_option: 'Sergio "Checo" Perez' , question_id: 94, correct: false},

    {name_option: 'Michael Schumacher' , question_id: 95, correct: false},
    {name_option: 'Carlos Sainz jr' , question_id: 95, correct: true},
    ...
    {name_option: 'Autodrome', question_id: 31, correct: false},
    {name_option: 'Hybrid', question_id: 31, correct: false},
    {name_option: 'Rural', question_id: 31, correct: true},
    {name_option: 'Street circuit', question_id: 31, correct: false},
    
    {name_option: 'Riverside', question_id: 32, correct: false},
    {name_option: 'Miami', question_id: 32, correct: false},
    {name_option: 'Mugello', question_id: 32, correct: false},
    {name_option: 'Las Vegas', question_id: 32, correct: true},
    
    {name_option: 'United States', question_id: 33, correct: true },
    {name_option: 'Spain', question_id: 33, correct: false },
    {name_option: 'England', question_id: 33, correct: false },
    {name_option: 'Italy', question_id: 33, correct: false },
    
    {name_option: 'AVUS', question_id: 34, correct: false},
    {name_option: 'Mónaco', question_id: 34, correct: true},
    {name_option: 'Yeda', question_id: 34, correct: false},
    {name_option: 'Zolder', question_id: 34, correct: false},
    
    {name_option: 'The Chapel', question_id: 35, correct: false },
    {name_option: 'Mount Silvano', question_id: 35, correct: false },
    {name_option: 'The Flying Kilometer', question_id: 35, correct: true },
    {name_option: 'The Flat Point', question_id: 35, correct: false },
    
    {name_option: '1986-1992', question_id: 36, correct: false},
    {name_option: '1999-2009', question_id: 36, correct: false},
    {name_option: '1975-1983', question_id: 36, correct: false},
    {name_option: '1985-1995', question_id: 36, correct: true},

    {name_option: 'Oscar and Juan Gálvez', question_id: 37, correct: true},
    {name_option: 'Juan Manuel Fangio', question_id: 37, correct: false},
    {name_option: 'Julio Argentino Roca', question_id: 37, correct: false},
    {name_option: 'Diego Armando Maradona', question_id: 37, correct: false},

    {name_option: 'Jerez', question_id: 38, correct: false},
    {name_option: 'Indianapolis', question_id: 38, correct: true},
    {name_option: 'Las Vegas', question_id: 38, correct: false},
    {name_option: 'Mónaco', question_id: 38, correct: false},

    {name_option: '19', question_id: 39, correct: false},
    {name_option: '20', question_id: 39, correct: false},
    {name_option: '21', question_id: 39, correct: true},
    {name_option: '22', question_id: 39, correct: false},

    {name_option: 'Monza', question_id: 40, correct: false},
    {name_option: 'Silverstone', question_id: 40, correct: false},
    {name_option: 'Zandvoort', question_id: 40, correct: false},
    {name_option: 'Aintree', question_id: 40, correct: true},

    {name_option: '37.000', question_id: 41, correct: true},
    {name_option: '38.000', question_id: 41, correct: false},
    {name_option: '36.000', question_id: 41, correct: false},
    {name_option: '40.000', question_id: 41, correct: false},

    {name_option: 'Fernando Alonso', question_id: 42, correct: false},
    {name_option: 'Lewis Hamilton', question_id: 42, correct: true},
    {name_option: 'Rubens Barrichello', question_id: 42, correct: false},
    {name_option: 'Max Verstappen', question_id: 42, correct: false},

    {name_option: '20', question_id: 43, correct: false},
    {name_option: '21', question_id: 43, correct: false},
    {name_option: '19', question_id: 43, correct: true},
    {name_option: '22', question_id: 43, correct: false},
    ...
    {name_option: 'Asphalt', question_id: 45, correct: true },
    {name_option: 'Grass', question_id: 45, correct: false },
    {name_option: 'Gravel', question_id: 45, correct: false },
    {name_option: 'Grass and Gravel', question_id: 45, correct: false },
    ...
    {name_option: 'None', question_id: 47, correct: true},
    ...
    {name_option: 'Europe', question_id: 49, correct: true},
    ...
    {name_option: '1 driver', question_id: 50, correct: false },
    {name_option: '2 drivers', question_id: 50, correct: true },
    {name_option: '3 drivers', question_id: 50, correct: false },
    {name_option: '4 drivers', question_id: 50, correct: false },

    {name_option: 'Max Verstappen and Sergio Perez', question_id: 51, correct: true},
    ...
    {name_option: 'Lewis Hamilton and George Russell', question_id: 52, correct: true},
    ...
    {name_option: 'Charles Leclerc and Carlos Sainz Jr', question_id: 53, correct: true},
    ...
    {name_option: 'Lando Norris and Oscar Piastri', question_id: 54, correct: true},
    ...
    {name_option: 'Lance Stroll and Fernando Alonso', question_id: 55, correct: true},
    {name_option: 'Nico Hülkenberg', question_id: 55, correct: false},
    {name_option: 'Sergio Pérez', question_id: 55, correct: false},

    {name_option: 'Esteban Ocon and Pierre Gasly', question_id: 56, correct: true},
    ...
    {name_option: 'Alexander Albon and Logan Sargeant', question_id: 57, correct: true},
    ...
    {name_option: 'Yuki Tsunoda and Daniel Ricciardo', question_id: 58, correct: true},
    ...
    {name_option: 'Valtteri Bottas and Guanyu Zhou', question_id: 59, correct: true },
    {name_option: 'Fictional team', question_id: 59, correct: false },
    {name_option: 'Not in Formula 1', question_id: 59, correct: false },
    {name_option: 'Development team', question_id: 59, correct: false },

    {name_option: 'Kevin Magnussen and Nico Hulkenberg', question_id: 60, correct: true},
    ...
    {name_option: '2nd place', question_id: 62, correct: false },
    {name_option: '3rd place', question_id: 62, correct: false },
    {name_option: '4th place', question_id: 62, correct: false },

    {name_option: 'Jaguar', question_id: 63, correct: true},
    {name_option: '2nd place', question_id: 63, correct: false },
    {name_option: '3rd place', question_id: 63, correct: false },
    {name_option: '4th place', question_id: 63, correct: false },

    {name_option: '1st place', question_id: 64, correct: true },
    {name_option: '2nd place', question_id: 64, correct: false },
    {name_option: '3rd place', question_id: 64, correct: false },
    {name_option: '4th place', question_id: 64, correct: false },
    ...
    {name_option: 'Austrian', question_id: 66, correct: true },
    {name_option: 'German', question_id: 66, correct: false },
    {name_option: 'British', question_id: 66, correct: false },
    {name_option: 'Italian', question_id: 66, correct: false },

    { name_option: 'Italian', question_id: 67, correct: false },
    { name_option: 'German', question_id: 67, correct: true },
    { name_option: 'British', question_id: 67, correct: false },
    { name_option: 'Austrian', question_id: 67, correct: false },

    {name_option: 'Karl Benz and Gottlieb Daimler', question_id: 68, correct: true},
    ...
    { name_option: '1st place', question_id: 69, correct: true },
    { name_option: '2nd place', question_id: 69, correct: false },
    { name_option: '3rd place', question_id: 69, correct: false },
    { name_option: '4th place', question_id: 69, correct: false },
    ...
    { name_option: 'Austrian', question_id: 71, correct: false },
    ...
    { name_option: '1st place', question_id: 73, correct: true },
    { name_option: '2nd place', question_id: 73, correct: false },
    { name_option: '3rd place', question_id: 73, correct: false },
    { name_option: '4th place', question_id: 73, correct: false },
    ...
    { name_option: 'Indicates the end of the race', question_id: 75, correct: true },
    ...
    { name_option: 'Timed lap qualifying session', question_id: 87, correct: true },

    { name_option: '60 laps', question_id: 88, correct: false },
