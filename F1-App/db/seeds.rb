...
profiles = [
  { name: 'Juan Cruz', lastName: 'Gonzalez', email: 'juancruzg30@gmail.com', description: 'f1 lover', age: 22,
    user_id: 3, profile_picture: '/profile_pictures/charles-leclerc-2024.png' },
  { name: 'Bruno', lastName: 'Conti', email: 'brunocse.5@gmail.com', description: 'messi lover', age: 21, user_id: 2,
    profile_picture: '/profile_pictures/charles-leclerc-2024.png' },
  { name: 'Erich', lastName: 'Vollenweider', email: 'vollenweidererich@gmail.com', description: 'KTM Group', age: 25,
    user_id: 4, profile_picture: '/profile_pictures/charles-leclerc-2024.png' },
  { name: 'Joaquin', lastName: 'Mezzano', email: 'mezzanojoaquin@gmail.com', description: 'intento de programador',
    age: 23, user_id: 1, profile_picture: '/profile_pictures/charles-leclerc-2024.png' },
  { name: 'Admin', lastName: 'Admin', email: 'admin@admin.com', description: 'The admin', age: 99, user_id: 5,
    profile_picture: '/profile_pictures/charles-leclerc-2024.png' }
]
...
questions = [
  { name_question: 'Who are the drivers with the most World Championships?', image_question: nil, level: 'easy',
    theme: 'pilot', correct: 0, incorrect: 0 },
  { name_question: 'Which of the following drivers is known as "The Iceman"?', image_question: nil,
    level: 'difficult', theme: 'pilot', correct: 0, incorrect: 0 },
  { name_question: 'Which driver holds the record for the most pole positions in history?', image_question: nil,
    level: 'normal', theme: 'pilot', correct: 0, incorrect: 0 },
  { name_question: 'Who is the youngest driver to have won a race?', image_question: nil, level: 'normal',
    theme: 'pilot', correct: 0, incorrect: 0 },
  { name_question: 'Which of the following drivers debuted at the youngest age in a race?', image_question: nil,
    level: 'difficult', theme: 'pilot', correct: 0, incorrect: 0 },
  { name_question: 'Which driver is known as "the professor" due to his strategy and calculation in races?',
    image_question: nil, level: 'difficult', theme: 'pilot', correct: 0, incorrect: 0 },
  { name_question: 'Which of the following drivers is the son of a world rally champion?', image_question: nil,
    level: 'easy', theme: 'pilot', correct: 0, incorrect: 0 },
  { name_question: 'Which of the mentioned drivers is Australian?', image_question: nil, level: 'normal',
    theme: 'pilot', correct: 0, incorrect: 0 },
  { name_question: 'Which driver won the most races in the Monaco Grand Prix?', image_question: nil,
    level: 'difficult', theme: 'pilot', correct: 0, incorrect: 0 },
  { name_question: 'Who is the youngest driver to win an F1 championship?', image_question: nil, level: 'normal',
    theme: 'pilot', correct: 0, incorrect: 0 },
  { name_question: 'Who is the only driver to win a championship with Renault?', image_question: nil,
    level: 'difficult', theme: 'pilot', correct: 0, incorrect: 0 },
  { name_question: 'Who is the first driver to win a race for Ferrari in history?', image_question: nil,
    level: 'difficult', theme: 'pilot', correct: 0, incorrect: 0 },
  { name_question: 'Who was the only driver to win the World Championship with Brawn GP?', image_question: nil,
    level: 'impossible', theme: 'pilot', correct: 0, incorrect: 0 },
  { name_question: 'How many world titles does former driver Juan Manuel Fangio have?', image_question: nil,
    level: 'normal', theme: 'pilot', correct: 0, incorrect: 0 },
  { name_question: 'Who is the driver with the most podiums (13) without winning a race?', image_question: nil,
    level: 'impossible', theme: 'pilot', correct: 0, incorrect: 0 },
  { name_question: 'In what year did Juan Manuel Fangio win his last world championship?', image_question: nil,
    level: 'difficult', theme: 'pilot', correct: 0, incorrect: 0 },
  { name_question: 'For which country did Emerson Fittipaldi and Felipe Massa race?', image_question: nil,
    level: 'easy', theme: 'pilot', correct: 0, incorrect: 0 },
  { name_question: 'Which drivers currently make up the MC-LAREN team?', image_question: nil, level: 'normal',
    theme: 'pilot', correct: 0, incorrect: 0 },
  { name_question: 'What nationality is former driver Sebastian Vettel?', image_question: nil, level: 'normal',
    theme: 'pilot', correct: 0, incorrect: 0 },
  { name_question: 'How many championships did Jim Clark win?', image_question: nil, level: 'difficult',
    theme: 'pilot', correct: 0, incorrect: 0 },
  { name_question: 'Which driver was involved in the remembered accident losing his life in Imola, Italy?',
    image_question: nil, level: 'normal', theme: 'pilot', correct: 0, incorrect: 0 },
  { name_question: 'What is the nationality of current driver Sergio "Checo" Perez?', image_question: nil,
    level: 'easy', theme: 'pilot', correct: 0, incorrect: 0 },
  { name_question: 'Is there currently an Argentine driver in F1?', image_question: nil, level: 'normal',
    theme: 'pilot', correct: 0, incorrect: 0 },
  { name_question: 'How many races did driver Michael Schumacher win?', image_question: nil, level: 'difficult',
    theme: 'pilot', correct: 0, incorrect: 0 },
  { name_question: 'Which driver, nicknamed “The Flying Scot,” won three World Championships in Formula 1?',
    image_question: nil, level: 'easy', theme: 'pilot', correct: 0, incorrect: 0 },

  { name_question: 'How many circuits have hosted races in the F1 world championship?', image_question: nil,
    level: 'normal', theme: 'circuit', correct: 0, incorrect: 0 },
  { name_question: 'In which circuit was the first F1 race held?', image_question: nil, level: 'easy',
    theme: 'circuit', correct: 0, incorrect: 0 },
  { name_question: 'What is the longest circuit used in the history of F1?', image_question: nil, level: 'easy',
    theme: 'circuit', correct: 0, incorrect: 0 },
  { name_question: 'How long is the longest circuit used in the history of F1?', image_question: nil, level: 'normal',
    theme: 'circuit', correct: 0, incorrect: 0 },
  { name_question: 'What is the circuit with the most editions?', image_question: nil, level: 'easy',
    theme: 'circuit', correct: 0, incorrect: 0 },
  { name_question: 'How many editions did the most used circuit have?', image_question: nil, level: 'easy',
    theme: 'circuit', correct: 0, incorrect: 0 },
  { name_question: 'Which of the following is NOT a type of circuit:', image_question: nil, level: 'normal',
    theme: 'circuit', correct: 0, incorrect: 0 },
  { name_question: 'What was the last circuit added to date?', image_question: nil, level: 'normal', theme: 'circuit',
    correct: 0, incorrect: 0 },
  { name_question: 'Which country has the most circuits in its territory?', image_question: nil, level: 'easy',
    theme: 'circuit', correct: 0, incorrect: 0 },
  { name_question: 'What is the shortest circuit used in the history of F1?', image_question: nil, level: 'difficult',
    theme: 'circuit', correct: 0, incorrect: 0 },
  { name_question: 'What is the name of the section of the Pescara circuit where Guy Moll died during 1934?',
    image_question: nil, level: 'difficult', theme: 'circuit', correct: 0, incorrect: 0 },
  { name_question: 'During which years was the Adelaide Street Circuit (Australia) active?', image_question: nil,
    level: 'impossible', theme: 'circuit', correct: 0, incorrect: 0 },
  { name_question: 'What is the name of the only Argentine circuit that was in F1?', image_question: nil,
    level: 'normal', theme: 'circuit', correct: 0, incorrect: 0 },
  ...
  { name_question: 'How many circuits are currently raced?', image_question: nil, level: 'easy', theme: 'circuit',
    correct: 0, incorrect: 0 },
  { name_question: 'Which circuit was not raced in the 21st century?', image_question: nil, level: 'difficult',
    theme: 'circuit', correct: 0, incorrect: 0 },
  { name_question: 'What is the approximate spectator capacity of the Monaco circuit?', image_question: nil,
    level: 'impossible', theme: 'circuit', correct: 0, incorrect: 0 },
  { name_question: 'Who holds the record for the fastest lap at the Monaco circuit?', image_question: nil,
    level: 'difficult', theme: 'circuit', correct: 0, incorrect: 0 },
  { name_question: 'How many corners does the Monaco circuit have?', image_question: nil, level: 'difficult',
    theme: 'circuit', correct: 0, incorrect: 0 },
  { name_question: 'What types of events do NOT take place at the Monaco circuit, aside from F1?',
    image_question: nil, level: 'normal', theme: 'circuit', correct: 0, incorrect: 0 },
  { name_question: 'What type of run-off areas does the Monza circuit NOT have?', image_question: nil,
    level: 'difficult', theme: 'circuit', correct: 0, incorrect: 0 },
  { name_question: 'Which circuit has the largest spectator capacity?', image_question: nil, level: 'normal',
    theme: 'circuit', correct: 0, incorrect: 0 },
  { name_question: 'Which circuit is over 100 years old since its first race?', image_question: nil,
    level: 'difficult', theme: 'circuit', correct: 0, incorrect: 0 },
  { name_question: 'How many circuits that were in F1 are located in South America?', image_question: nil,
    level: 'normal', theme: 'circuit', correct: 0, incorrect: 0 },
  { name_question: 'Which continent has the most circuits raced in F1?', image_question: nil, level: 'easy',
    theme: 'circuit', correct: 0, incorrect: 0 },

  { name_question: 'How many drivers does each team compete with in each race?', image_question: nil, level: 'easy',
    theme: 'team', correct: 0, incorrect: 0 },
  ...
  { name_question: 'Who are the current Haas drivers?', image_question: nil, level: 'difficult', theme: 'team',
    correct: 0, incorrect: 0 },
  { name_question: 'In what year did Red Bull start in motorsport?', image_question: nil, level: 'impossible',
    theme: 'team', correct: 0, incorrect: 0 },
  { name_question: 'Who was the founder of Red Bull?', image_question: nil, level: 'impossible', theme: 'team',
    correct: 0, incorrect: 0 },
  { name_question: 'What was the predecessor team to Red Bull?', image_question: nil, level: 'difficult',
    theme: 'team', correct: 0, incorrect: 0 },
  { name_question: 'What was the best position in the Constructors\' World Championship for Red Bull?',
    image_question: nil, level: 'normal', theme: 'team', correct: 0, incorrect: 0 },
  { name_question: 'What was the best position in the Drivers\' World Championship for Red Bull?',
    image_question: nil, level: 'normal', theme: 'team', correct: 0, incorrect: 0 },
  ...
  { name_question: 'Who was the founder of Mercedes?', image_question: nil, level: 'impossible', theme: 'team',
    correct: 0, incorrect: 0 },
  { name_question: 'What was the best position in the Constructors\' World Championship for Mercedes?',
    image_question: nil, level: 'normal', theme: 'team', correct: 0, incorrect: 0 },
  { name_question: 'What was the best position in the Drivers\' World Championship for Mercedes?',
    image_question: nil, level: 'normal', theme: 'team', correct: 0, incorrect: 0 },
  { name_question: 'What is the nationality of Ferrari?', image_question: nil, level: 'easy', theme: 'team',
    correct: 0, incorrect: 0 },
  { name_question: 'Who was the founder of Ferrari?', image_question: nil, level: 'normal', theme: 'team', correct: 0,
    incorrect: 0 },
  { name_question: 'What was the best position in the Constructors\' World Championship for Ferrari?',
    image_question: nil, level: 'normal', theme: 'team', correct: 0, incorrect: 0 },
  { name_question: 'What was the best position in the Drivers\' World Championship for Ferrari?', image_question: nil,
    level: 'normal', theme: 'team', correct: 0, incorrect: 0 },
  ...
  { name_question: 'What does the yellow flag indicate?', image_question: nil, level: 'normal', theme: 'career',
    correct: 0, incorrect: 0 },
  { name_question: 'What does the yellow flag next to sign Safety Car indicate?', image_question: nil,
    level: 'difficult', theme: 'career', correct: 0, incorrect: 0 },
  { name_question: 'What does the yellow flag next to sign Virtual Safety Car indicate?', image_question: nil,
    level: 'impossible', theme: 'career', correct: 0, incorrect: 0 },
  { name_question: 'What does the red flag indicate?', image_question: nil, level: 'easy', theme: 'career',
    correct: 0, incorrect: 0 },
  { name_question: 'What does the black flag with the driver\'s number indicate?', image_question: nil,
    level: 'difficult', theme: 'career', correct: 0, incorrect: 0 },
  { name_question: 'What does a black flag with an orange circle mean?', image_question: nil, level: 'impossible',
    theme: 'career', correct: 0, incorrect: 0 },
  { name_question: 'What does the split (black and white) flag with the number indicate?', image_question: nil,
    level: 'impossible', theme: 'career', correct: 0, incorrect: 0 },
  { name_question: 'What does the blue flag indicate?', image_question: nil, level: 'normal', theme: 'career',
    correct: 0, incorrect: 0 },
  { name_question: 'What does the yellow flag with red stripes indicate?', image_question: nil, level: 'impossible',
    theme: 'career', correct: 0, incorrect: 0 },
  { name_question: 'What does the white flag indicate?', image_question: nil, level: 'easy', theme: 'career',
    correct: 0, incorrect: 0 },
  { name_question: 'What is the qualifying system used in Formula 1?', image_question: nil, level: 'difficult',
    theme: 'career', correct: 0, incorrect: 0 },
  { name_question: 'What is the maximum number of laps allowed in a Formula 1 race?', image_question: nil,
    level: 'normal', theme: 'career', correct: 0, incorrect: 0 },
  { name_question: 'What is the approximate duration of a Formula 1 race?', image_question: nil, level: 'normal',
    theme: 'career', correct: 0, incorrect: 0 },
  { name_question: 'What is the common number of drivers on a Formula 1 starting grid?', image_question: nil,
    level: 'normal', theme: 'career', correct: 0, incorrect: 0 },
  { name_question: 'What happens if a driver consistently exceeds track limits during the race?', image_question: nil,
    level: 'difficult', theme: 'career', correct: 0, incorrect: 0 },
  { name_question: 'What is the maximum speed allowed in the pit lane during a Formula 1 race?', image_question: nil,
    level: 'normal', theme: 'career', correct: 0, incorrect: 0 },
  { name_question: 'How are drivers and teams rewarded according to their performance in the Formula 1 race?',
    image_question: nil, level: 'normal', theme: 'career', correct: 0, incorrect: 0 },
  { name_question: 'How many points does the driver who achieves the fastest lap in a race receive?',
    image_question: nil, level: 'easy', theme: 'career', correct: 0, incorrect: 0 },
  { name_question: 'How many drivers receive points at the end of each race?', image_question: nil,
    level: 'difficult', theme: 'career', correct: 0, incorrect: 0 },
  { name_question: 'In what year was the first race in F1 history??', image_question: nil, level: 'normal',
    theme: 'career', correct: 0, incorrect: 0 },
  { name_question: 'What technical regulations govern car specifications in Formula 1?', image_question: nil,
    level: 'difficult', theme: 'career', correct: 0, incorrect: 0 },
  { name_question: 'What do drivers have to do at the end of a race?', image_question: nil, level: 'impossible',
    theme: 'career', correct: 0, incorrect: 0 },
  { name_question: 'What happens if a driver ignores three consecutive blue flags?', image_question: nil,
    level: 'difficult', theme: 'career', correct: 0, incorrect: 0 },

  { name_question: 'Which driver is joining Ferrari in 2025?', image_question: nil, level: 'easy', theme: 'free',
    correct: 0, incorrect: 0 },
  { name_question: 'How do you win the drivers championship at the end of the world championship?',
    image_question: nil, level: 'easy', theme: 'free', correct: 0, incorrect: 0 },
  { name_question: 'Which driver is leaving Ferrari this year (2024)?', image_question: nil, level: 'normal',
    theme: 'free', correct: 0, incorrect: 0 },
  { name_question: 'Who was the pilot of Mercedes in 2022 accompanying Lewis Hamilton?', image_question: nil,
    level: 'normal', theme: 'free', correct: 0, incorrect: 0 },
  { name_question: 'What type of garment has to be fireproof according to the FIA regulations?', image_question: nil,
    level: 'difficult', theme: 'free', correct: 0, incorrect: 0 },
  { name_question: 'Which team has the most Constructors Championships in F1 history?', image_question: nil,
    level: 'difficult', theme: 'free', correct: 0, incorrect: 0 },
  { name_question: 'In what year were hybrid engines introduced in F1?', image_question: nil, level: 'impossible',
    theme: 'free', correct: 0, incorrect: 0 },
  { name_question: 'What are drivers prohibited from using during a race?', image_question: nil, level: 'impossible',
    theme: 'free', correct: 0, incorrect: 0 },

  { name_question: nil, image_question: '/grandprix/imagen8.png', level: 'easy', theme: 'grandprix', correct: 0,
    incorrect: 0 },
  { name_question: nil, image_question: '/grandprix/imagen12.png', level: 'easy', theme: 'grandprix', correct: 0,
    incorrect: 0 },
  { name_question: nil, image_question: '/grandprix/imagen16.png', level: 'easy', theme: 'grandprix', correct: 0,
    incorrect: 0 },
  { name_question: nil, image_question: '/grandprix/imagen21.png', level: 'easy', theme: 'grandprix', correct: 0,
    incorrect: 0 },
  { name_question: nil, image_question: '/grandprix/imagen14.png', level: 'easy', theme: 'grandprix', correct: 0,
    incorrect: 0 },
  { name_question: nil, image_question: '/grandprix/imagen10.png', level: 'easy', theme: 'grandprix', correct: 0,
    incorrect: 0 },
  { name_question: nil, image_question: '/grandprix/imagen9.png', level: 'easy', theme: 'grandprix', correct: 0,
    incorrect: 0 },
  { name_question: nil, image_question: '/grandprix/imagen3.png', level: 'easy', theme: 'grandprix', correct: 0,
    incorrect: 0 },
  { name_question: nil, image_question: '/grandprix/imagen1.png', level: 'normal', theme: 'grandprix', correct: 0,
    incorrect: 0 },
  { name_question: nil, image_question: '/grandprix/imagen2.png', level: 'normal', theme: 'grandprix', correct: 0,
    incorrect: 0 },
  { name_question: nil, image_question: '/grandprix/imagen7.png', level: 'normal', theme: 'grandprix', correct: 0,
    incorrect: 0 },
  { name_question: nil, image_question: '/grandprix/imagen17.png', level: 'normal', theme: 'grandprix', correct: 0,
    incorrect: 0 },
  { name_question: nil, image_question: '/grandprix/imagen18.png', level: 'normal', theme: 'grandprix', correct: 0,
    incorrect: 0 },
  { name_question: nil, image_question: '/grandprix/imagen23.png', level: 'normal', theme: 'grandprix', correct: 0,
    incorrect: 0 },
  { name_question: nil, image_question: '/grandprix/imagen24.png', level: 'normal', theme: 'grandprix', correct: 0,
    incorrect: 0 },
  { name_question: nil, image_question: '/grandprix/imagen20.png', level: 'normal', theme: 'grandprix', correct: 0,
    incorrect: 0 },
  { name_question: nil, image_question: '/grandprix/imagen5.png', level: 'difficult', theme: 'grandprix', correct: 0,
    incorrect: 0 },
  { name_question: nil, image_question: '/grandprix/imagen13.png', level: 'difficult', theme: 'grandprix', correct: 0,
    incorrect: 0 },
  { name_question: nil, image_question: '/grandprix/imagen11.png', level: 'difficult', theme: 'grandprix', correct: 0,
    incorrect: 0 },
  { name_question: nil, image_question: '/grandprix/imagen15.png', level: 'difficult', theme: 'grandprix', correct: 0,
    incorrect: 0 },
  { name_question: nil, image_question: '/grandprix/imagen6.png', level: 'difficult', theme: 'grandprix', correct: 0,
    incorrect: 0 },
  { name_question: nil, image_question: '/grandprix/imagen19.png', level: 'difficult', theme: 'grandprix', correct: 0,
    incorrect: 0 },
  { name_question: nil, image_question: '/grandprix/imagen22.png', level: 'difficult', theme: 'grandprix', correct: 0,
    incorrect: 0 },
  { name_question: nil, image_question: '/grandprix/imagen4.png', level: 'difficult', theme: 'grandprix', correct: 0,
    incorrect: 0 },
...
options = [
  ...
  { name_option: 'Indicates that the safety car or virtual safety car is coming out', question_id: 77,
    correct: false },
  ...
  { name_option: 'Indicates that the warned driver will be excluded from the session', question_id: 82,
    correct: true },
  ...
  { name_option: 'Indicates to drivers that the track conditions are not optimal for driving at the limit',
    question_id: 86, correct: true },
  ...
  { name_option: 'Indicates that there is an excessively slow vehicle on track, such as a crane or medical car',
    question_id: 87, correct: true },
...
options.each do |option|
  ...
  if existing_option.nil?
    Option.create(name_option: option[:name_option], question_id: option[:question_id],
