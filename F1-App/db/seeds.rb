...
options = [
    ...
    {name_option: 'Estados Unidos', question_id: 33, correct: true},
    {name_option: 'España', question_id: 33, correct: false},
    {name_option: 'Inglaterra', question_id: 33, correct: false},
    {name_option: 'Italia', question_id: 33, correct: false},
    ...
    {name_option: 'La capilla', question_id: 35, correct: false},
    {name_option: 'El monte Silvano', question_id: 35, correct: false},
    {name_option: 'El kilómetro volador', question_id: 35, correct: true},
    {name_option: 'El punto raso', question_id: 35, correct: false},
    ...
    {name_option: 'Oscar y Juan Gálvez', question_id: 37, correct: true},
