...
RSpec.describe 'The App' do
  ...
  describe 'GET /profile/add-question as admin' do
    context 'when user is logged in and is an admin' do
      let(:user) do
        User.create(username: 'testuser', password: 'testpassword', cant_life: 3, cant_coins: 0, admin: true)
      end

      let(:profile) do
        Profile.create(
          name: 'testname', lastName: 'testLastName', description: 'testDescription',
          age: 21, profile_picture: '/profile_pictures/charles-leclerc-2024.png', user_id: user.id
        )
      end
  ...
  describe 'GET /profile/add-question as non-admin' do
    context 'when user is logged in but is not an admin' do
      let(:user) do
        User.create(username: 'testuser', password: 'testpassword', cant_life: 3, cant_coins: 0, admin: false)
      end
  ...
  describe 'GET /profile/add-question when not logged in' do
  ...
  describe 'POST /profile/add-question' do
    ...
    context 'when adding a text question' do
      it 'creates a new text question and options' do
        post '/profile/add-question', {
          question_type: 'text', question_text: 'testquestion', difficulty: 'easy', theme: 'team',
          option1: 'op1', option2: 'op2', option3: 'op3', option4: 'op4', correct_answer: 'option1'
        }
        expect(last_response).to be_redirect
        follow_redirect!
      ...
      it 'does not allow duplicate questions' do
        Question.create(name_question: 'duplicate question', level: 'easy', theme: 'team')

        post '/profile/add-question', {
          question_type: 'text', question_text: 'duplicate question', difficulty: 'easy', theme: 'team',
          option1: 'op1', option2: 'op2', option3: 'op3', option4: 'op4', correct_answer: 'option1'
        }
    ...
    context 'when adding an image question' do
      context 'with valid format' do
        it 'creates a new image question' do
          ...
          post '/profile/add-question', {
            question_type: 'image', question_image: image_file, difficulty: 'easy', theme: 'team',
            option1: 'op1', option2: 'op2', option3: 'op3', option4: 'op4', correct_answer: 'option1'
          }
      ...
      context 'with invalid format' do
        it 'rejects the invalid image format' do
          ...
          post '/profile/add-question', {
            question_type: 'image', question_image: invalid_image, difficulty: 'easy', theme: 'team',
            option1: 'op1', option2: 'op2', option3: 'op3', option4: 'op4', correct_answer: 'option1'
          }
      ...
      context 'without uploading an image' do
        it 'rejects the request and shows an error' do
          post '/profile/add-question', {
            question_type: 'image', difficulty: 'easy', theme: 'team',
            option1: 'op1', option2: 'op2', option3: 'op3', option4: 'op4', correct_answer: 'option1'
          }
    ...
    context 'when saving the question fails for any reason' do
      it 'shows an error message' do
        ...
        post '/profile/add-question', {
          question_type: 'text', question_text: 'test question', difficulty: 'easy', theme: 'team',
          option1: 'op1', option2: 'op2', option3: 'op3', option4: 'op4', correct_answer: 'option1'
        }
