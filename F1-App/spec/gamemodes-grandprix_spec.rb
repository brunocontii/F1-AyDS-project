    ...
    describe 'GET /gamemodes/grandprix' do
        ...
        context 'when the user has answered all questions in the easy difficulty' do
            ...
            before do
                ...
                env 'rack.session', { username: user.username, grandprix_mode_difficulty: 'easy', answered_grandprix_questions: Question.where(level: 'easy', theme: 'grandprix').pluck(:id) }
                get '/gamemodes/grandprix'
            end
        ...
        context 'when the user has answered all questions in the normal difficulty' do
            let!(:normal_question) { Question.create(name_question: 'Normal Question', level: 'normal', theme: 'grandprix') }
            ...
            before do
                ...
                env 'rack.session', { username: user.username, grandprix_mode_difficulty: 'normal', answered_grandprix_questions: Question.where(level: 'normal', theme: 'grandprix').pluck(:id) }
                get '/gamemodes/grandprix'
            end
        ...
        context 'when the user has answered all questions in the difficult difficulty' do
            let!(:difficult_question) { Question.create(name_question: 'Difficult Question', level: 'difficult', theme: 'grandprix') }
            ...
            before do
                ...
                env 'rack.session', { username: user.username, grandprix_mode_difficulty: 'difficult', answered_grandprix_questions: Question.where(level: 'difficult', theme: 'grandprix').pluck(:id) }
                get '/gamemodes/grandprix'
            end
        ...
        context 'when the user completes the impossible level' do
            let!(:impossible_question) { Question.create(name_question: 'Impossible Question', level: 'impossible', theme: 'grandprix') }
            ...
            before do
                ...
                env 'rack.session', { username: user.username, grandprix_mode_difficulty: 'impossible', answered_grandprix_questions: Question.where(level: 'impossible', theme: 'grandprix').pluck(:id) }
                get '/gamemodes/grandprix'
            end
            ...
            it 'resets the difficulty to easy, resets answered questions, and shows the completion message' do
                ...
                expect(last_request.env['rack.session'][:message]).to eq("Congratulations! You've completed the Grand Prix Mode.")
